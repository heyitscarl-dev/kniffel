...
BOX_2_WIDTH, BOX_2_HEIGHT = 135 // 2, 80 // 2
BOX_2_X, BOX_2_Y = 414 // 2, 216 // 2

def new_box(image_x, image_y, box_x, box_y):
    x = image_x + BOX_2_X + (box_x * BOX_2_WIDTH)
    y = image_y + BOX_2_Y + (box_y * BOX_2_HEIGHT)
    return pygame.Rect(x, y, BOX_2_WIDTH, BOX_2_HEIGHT)
